...
export const siteContent = {
  ...
  logo: "/assets/soar-supplied-logo.webp",
  generatedIcon: "/assets/soar-brand-icon.webp",
  heroImage: "/assets/soar-hero-paper.webp",
  studyImage: "/assets/soar-study-desk.webp",
  patternImage: "/assets/soar-orbit-pattern.webp",
  metrics: [
